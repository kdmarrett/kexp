...
\begin{abstract}
    ...
    community of individuals who rely on speller systems.
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.3\textwidth]{Accuracy_barplot}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.3\textwidth]{Meanbasecorrectedpupilsize_barplot}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.3\textwidth]{Weightedcognitiveloadsurvey_barplot}
