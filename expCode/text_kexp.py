...
instr['s0_start_block_0'] = ('In the first section, you will be introduced to the different condition types. This section contains'
	...
	' gray, and pay attention to the green highlighted letter that is spoken at the beginning of each trial. '
...
instr['s1_start_block_0'] = ('You\'re about to begin the first block in this section.  Here we go!'.format(cont_btn_label))
...
instr['s2_start_block_0'] = ( 'After performing the task for each condition,'
		...
		'If you have a question about any of the scales, please don\'t hesitate to ask someone outside the booth. Press "{}" to begin.'.format(cont_btn_label))
...
gen_survey[0] = ('How mentally demanding was the task? How much mental and perceptual activity was required (e.g.'
                 ...
                 'complex, exacting or forgiving? When you are finished, press "{}" to continue.'.format(cont_btn_label))
...
gen_survey[1] = ('How much physical activity was required (e.g. pushing, pulling, turning, controlling, activating)?'
                 ...
                 ' you are finished, press "{}" to continue.'.format(cont_btn_label))
...
mid_survey[1] = ('Now you will be presented with a series of pairs of rating scale titles (for '
                 ...
                 'are only interested in your opinion.'.format(cont_btn_label))

rel_survey = dict()
rel_survey[0] = '1. Physical Demand or 2. Temporal Demand. Choose the aspect that you consider the larger factor contributing to the workload.'
rel_survey[1] = '1. Effort or 2. Mental Demand. Choose the aspect that you consider the larger factor contributing to the workload.'
rel_survey[2] = '1. Frustration or 2. Physical Demand. Choose the aspect that you consider the larger factor contributing to the workload.'
rel_survey[3] = '1. Effort or 2. Frustration. Choose the aspect that you consider the larger factor contributing to the workload.'
rel_survey[4] = '1. Mental Demand or 2. Temporal Demand. Choose the aspect that you consider the larger factor contributing to the workload.'
rel_survey[5] = '1. Physical Demand or 2. Effort. Choose the aspect that you consider the larger factor contributing to the workload.'
rel_survey[6] = '1. Temporal Demand or 2. Performance. Choose the aspect that you consider the larger factor contributing to the workload.'
rel_survey[7] = '1. Frustration or 2. Mental Demand. Choose the aspect that you consider the larger factor contributing to the workload.'
rel_survey[8] = '1. Temporal Demand or 2. Frustration. Choose the aspect that you consider the larger factor contributing to the workload.'
rel_survey[9] = '1. Performance or 2. Effort. Choose the aspect that you consider the larger factor contributing to the workload.'
rel_survey[10] = '1. Effort or 2. Temporal Demand. Choose the aspect that you consider the larger factor contributing to the workload.'
rel_survey[11] = '1. Frustration or 2. Performance. Choose the aspect that you consider the larger factor contributing to the workload.'
rel_survey[12] = '1. Performance or 2. Physical Demand. Choose the aspect that you consider the larger factor contributing to the workload.'
rel_survey[13] = '1. Mental Demand or 2. Performance. Choose the aspect that you consider the larger factor contributing to the workload.'
rel_survey[14] = '1. Mental Demand or 2. Physical Demand. Choose the aspect that you consider the larger factor contributing to the workload.'

template = dict.fromkeys(instr)
button_keys = dict(template.items() + button_keys.items()) #override template with explicit values so far
